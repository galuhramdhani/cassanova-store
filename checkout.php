    ...
    <div class="container-fluid">
        ...
        echo '
            <div class="col-75">
                ...
                <form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
                    <div class="row-checkout">
                        <div class="col-50">
                            ...
                            <label for="idgame"><i class="fa fa-gamepad"></i> ID Game</label>
                            <input type="text" id="idgame" name="id_game" class="form-control" required>
                        ...
                        <div class="col-50">
                            <!-- Placeholder untuk kolom lain jika diperlukan -->
                        </div>
                    </div>
                    <label><input type="checkbox" name="q" class="roomselect" value="confirm" required> Apakah Data di atas Telah Benar</label>';

                    // Penanganan item dalam keranjang (sebelumnya diterima dari form cart.php)
                    $i=1;
                    $total=0;
                ...
                <button type="submit" class="btn btn-sm btn-primary mb-3">Konfirmasi Bayar</button>

          ...
          (function (a) {
            return (
              ...
              (a.fn.payform = function (b) {
                return (
                  null != a.payform.fn[b] && a.payform.fn[b].call(this), this
                )
              })
            )
        ...
        !(function (a, c) {
          ...
          return (
            ...
            (p = function (a) {
              ...
              return (
                (b = v(a.target)),
                (a.target.value = m.formatCardExpiry(a.target.value)),
                null != b && 'change' !== a.type
                  ? a.target.setSelectionRange(b, b)
                  : void 0
              )
            ...
            (r = function (b) {
              ...
              return (
                ...
                /^\d+$/.test(d) && !k(b.target)
                  ? ((e = (b.target.value + d).replace(/\D/g, '')),
                    (c = a(e)),
                    c && e.length > c.length[c.length.length - 1]
                      ? b.preventDefault()
                      : e.length > 16
                      ? b.preventDefault()
                      : void 0)
              ...
              return (
                ...
                /^\d+$/.test(b)
                  ? ((c = a(b)),
                    c
                      ? ((e = b.length),
                        d.call(c.length, e) >= 0 && (c.luhn === !1 || l(b)))
                      : !1)
                  : !1
              )
            }),
            ...
            (m.validateCardCVC = function (a, c) {
              ...
              return (
                ...
                /^\d+$/.test(a)
                  ? ((e = b(c)),
                    null != e
                      ? ((f = a.length), d.call(e.cvcLength, f) >= 0)
              ...
              return (
                ...
                (c = a(b))
                  ? ((e = c.length[c.length.length - 1]),
                    (b = b.slice(0, e)),
                    c.format.global
                      ? null != (f = b.match(c.format))
                        ? f.join(' ')
                        : void 0
                      : ((d = c.format.exec(b)),
                        null != d
                          ? (d.shift(), (d = d.filter(Boolean)), d.join(' '))
                          : void 0))
                  : b
              )
            }),
